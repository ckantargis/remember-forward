...
A specimen part is attached — `plate_coupon_b_engraving` in DXF, PDF and SVG. It was drawn specifically so you can quote against real geometry rather than a
